        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Profile</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/seller-dashboard"><i class="zmdi zmdi-home"></i> Dashboard</a></li>
            ...
            <div class="row clearfix">
                <div class="col-md-6">
                    <div class="card mcard_3">
                        <div class="body">
                           <img style="height: 60px; width:60px;" src="{{ asset('asset/image/seller_profile')}}/{{ Auth::user()->image}}" class="rounded-circle shadow " alt="profile-image">
