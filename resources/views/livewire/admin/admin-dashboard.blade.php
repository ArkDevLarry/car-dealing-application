            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card mcard_4">
                    <div class="body">
                        ...
                        <div class="img">
                            <img src="backend/assets/images/lg/avatar1.jpg" class="rounded-circle" alt="profile-image">
                        </div>
                        <div class="user">
                    ...
                    <div class="body">
                        <div class="chat-widget">
                            <ul class="list-unstyled">
                                <li class="left">
                                    <img src="backend/assets/images/xs/avatar3.jpg" class="rounded-circle" alt="">
                                ...
                                <li class="left">
                                    <img src="backend/assets/images/xs/avatar2.jpg" class="rounded-circle" alt="">
                                    <ul class="list-unstyled chat_info">
                                ...
                                <li class="left">
                                    <img src="backend/assets/images/xs/avatar5.jpg" class="rounded-circle" alt="">
                                    <ul class="list-unstyled chat_info">
