...
<section class="listing_detail_header" style="background: rgba(0, 0, 0, 0) url({{ asset('asset/image/vehicleImages') }}/{{ $images_single->image}}) no-repeat fixed center center / cover;">
    <div class="container">
      <div class="listing_detail_head white-text div_zindex row">
        <div class="col-md-9">
          <h2>{{ $details->name }}</h2>
          <div class="car-location"><span><i class="fa fa-map-marker" aria-hidden="true"></i> &nbsp;{{ $details->location }}</span></div>
        ...
        <aside class="col-md-3">
          ...
          <div class="sidebar_widget">
            ...
            <div style="display: flex; justify-content:center; align-items:center;">
              ...
              <a href="{{ route('login') }}" class="btn btn-xs">Click to Login</a>
            </div>
            @endif
          </div>
          <div class="sidebar_widget">
