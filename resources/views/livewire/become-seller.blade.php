          ...
          <div class="profile_wrap">
            ...
            <form method="POST" wire:submit.prevent="beSeller" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input class="form-control white_bg" id="password" type="password" wire:model="password">
                @error('password')<p class="text-danger">{{ $message }}</p> @enderror
              </div>
              <div class="form-group">
                <label class="control-label">Confirm Password</label>
                <input class="form-control white_bg" id="c-password" type="password" wire:model="password_confirmation">
