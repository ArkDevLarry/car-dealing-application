...
<link rel="stylesheet" href="backend/assets/plugins/charts-c3/plugin.css"/>
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="backend/assets/images/loader.svg" width="48" height="48" alt="Aero"></div>
        <p>Please wait...</p>
    </div>
</div>
...
<div class="navbar-right">
    <ul class="navbar-nav">
                        ...
                        <li>
                            <div class="progress-container progress-primary">
                                ...
                                <ul class="list-unstyled team-info">
                                    ...
                                    <li>
                                        <img src="backend/assets/images/xs/avatar2.jpg" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="backend/assets/images/xs/avatar3.jpg" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="backend/assets/images/xs/avatar4.jpg" alt="Avatar">
                                    </li>                            
                                </ul>
                            </div>
                        </li>
                        <li>
                            <div class="progress-container">
                                ...
                                <ul class="list-unstyled team-info">
                                    <li class="m-r-15"><small>Team</small></li>
                                    <li>
                                        <img src="backend/assets/images/xs/avatar10.jpg" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="backend/assets/images/xs/avatar9.jpg" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="backend/assets/images/xs/avatar8.jpg" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="backend/assets/images/xs/avatar7.jpg" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="backend/assets/images/xs/avatar6.jpg" alt="Avatar">
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li>
                            <div class="progress-container progress-warning">
                                ...
                                <ul class="list-unstyled team-info">
                                    <li class="m-r-15"><small>Team</small></li>
                                    <li>
                                        <img src="backend/assets/images/xs/avatar5.jpg" alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="backend/assets/images/xs/avatar2.jpg" alt="Avatar">
                                    </li>
        ...
        <li>
            <a  href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="mega-menu" title="Sign Out"><i class="zmdi zmdi-power"></i></a>
...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="navbar-brand">
        ...
        <a href="/admin-dashboard"><img src="backend/assets/images/logo.svg" width="25" alt="Aero"><span class="m-l-10">Aero</span></a>
    </div>
    @else
    <div class="navbar-brand">
        <button class="btn-menu ls-toggle-btn" type="button"><i class="zmdi zmdi-menu"></i></button>
        <a href="/seller-dashboard"><img src="backend/assets/images/logo.svg" width="25" alt="Aero"><span class="m-l-10">Aero</span></a>
    </div>
    @endif
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"><a href="/admin-dashboard"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
            <li><a href="/AdminProfile"><i class="zmdi zmdi-account"></i><span>Profile</span></a></li>
    ...
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <a class="image" ><img style="width:40px; height:40px;" src="{{ asset('asset/image/seller_profile') }}/{{ Auth::user()->image}}"></a>
                    <div class="detail">
                        <h4>{{ Auth::user()->firstname.' '.Auth::user()->lastname }}</h4>                      
                    </div>
                </div>
            </li>
            <li class="active open"><a href="/seller-dashboard"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
            <li><a href="/SellerProfile"><i class="zmdi zmdi-account"></i><span>Profile</span></a></li>
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-apps"></i><span>My Cars</span></a>
                <ul class="ml-menu">
                    <li><a href="/SellCars">Sell A Car</a></li>
                    <li><a href="/ViewSellerCars">View My Cars</a></li>                   
                </ul>
            </li>
            {{-- <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Projects</span></a>
                <ul class="ml-menu">
...
<script src="backend/assets/bundles/sparkline.bundle.js"></script> <!-- Sparkline Plugin Js -->
<script src="backend/assets/bundles/c3.bundle.js"></script>
...
<script>
    window.addEventListener('seller-success', event => {
        ...
        timer: 2000
            ...
            window.location = '{{ route('ViewSellerCars') }}';
        });
    })
</script>
<script>
    window.addEventListener('upload-error', event => {
        ...
        timer: 2000
            ...
            window.location = '{{ route('SellCars') }}';
        });
    })
</script>
<script>
